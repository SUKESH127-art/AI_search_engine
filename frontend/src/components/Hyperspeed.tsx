...
class App {
  ...
  clock: THREE.Clock;
  assets: { smaa?: { search?: HTMLImageElement; area?: HTMLImageElement } } & Record<string, unknown>;
  disposed: boolean;
  road: Road;
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  return <div id="lights" className="w-full h-full absolute inset-0 min-w-full min-h-full" ref={hyperspeed} style={{ width: '100%', height: '100%' }}></div>;
};
