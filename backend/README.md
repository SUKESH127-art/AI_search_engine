# Fleetline Agent Backend - Architecture Documentation

A FastAPI-based backend system that powers an AI agent using LangGraph for query processing, search result synthesis, and conversational responses. The system integrates with BrightData SERP API for web search and OpenAI for LLM-based synthesis.
